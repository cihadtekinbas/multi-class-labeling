...
trainArticle, testArticle, trainTag, testTag, binaryTrainArticle, binaryTestArticle, L1normTrainArticle ,L1normTestArticle, L2normTrainArticle, L2normTestArticle = readData("E:\\1-baseline\\")
#trainArticle, testArticle, trainTag, testTag = readData("C:\\Users\\asus\\data\\")

workbook = xlsxwriter.Workbook('baseline1.xlsx')
