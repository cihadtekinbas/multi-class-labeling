...
def writefile(number,trie,tag_dict):
    ...
    f1=open("/home/asus/Desktop/Classification/lastversion/2-ChooseWordsFromGlove/Data/datanew"+str(number),"w")            
    for y in name_list:
        name_list[y].reverse()
        # print(name_list[y])
        f1.write(str(name_list[y]))
        f1.write("\n")
    f2=open("/home/asus/Desktop/Classification/lastversion/2-ChooseWordsFromGlove/Data/datadnew"+str(number),"w")
    for y in detail_info:
        detail_info[y].reverse()
        # print(detail_info[y])
        f2.write(str(detail_info[y]))
        f2.write("\n")
    f3=open("/home/asus/Desktop/Classification/lastversion/2-ChooseWordsFromGlove/Data/datapnew"+str(number),"w")
    for y in name_list:
        # name_list[y].reverse()
        # print(name_list[y])
        num1=0
